        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black flex items-center justify-center px-4">
            <div className="glassmorphism rounded-2xl p-8 max-w-md w-full text-center">
                ...
                <p className="text-gray-400 mb-8">
                    Connectez-vous pour gérer vos clans
                </p>

                <button
                    onClick={() => signIn('google', { callbackUrl: '/' })}
                    className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-white hover:bg-gray-100 text-gray-800 font-medium transition-all mb-4"
                >
